...
export class Room {
  ...
  static create(options: Partial<Room>): Room {
    ...
    room.commanderClistTier =
      options.commanderClistTier ?? room.commanderClistTier;
    room.commanderCodeforcesRating =
      options.commanderCodeforcesRating ?? room.commanderCodeforcesRating;
    return room;
  }
